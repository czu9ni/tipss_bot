...
class AppConfig(BaseModel):
    ...
    sportradar_api_key: str = Field(default="", description="Sportradar API key")
    sportradar_api_base: str = Field(default="", description="Sportradar API base URL")
...
def load_config(environ: dict[str, str] | None = None) -> AppConfig:
    ...
    try:
        return AppConfig(
            ...
            sportradar_api_key=env.get("SPORTRADAR_API_KEY", ""),
            sportradar_api_base=env.get("SPORTRADAR_API_BASE", ""),
